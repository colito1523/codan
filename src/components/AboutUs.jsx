...
<p className="paragraph">
  <span className="name-highlight">Alejandro</span> destaca por su enfoque profesional, siempre guiando a sus alumnos a superar sus límites y
  encontrar su mejor versión.
</p>
<p className="paragraph">
  <span className="name-highlight">Valentino</span> se distingue por su meticulosidad en la planificación de rutinas y dietas, asegurándose de que
  cada aspecto de la salud de sus clientes esté cubierto.
</p>
<p className="paragraph">
