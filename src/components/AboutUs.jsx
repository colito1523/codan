...
src={alejandroImg}
          ...
          <div className="about-text">
            ...
            <p className="paragraph">
              Alejandro destaca por su enfoque profesional, siempre guiando a sus alumnos a superar sus límites y
              encontrar su mejor versión.
            </p>
            <p className="paragraph">
              Valentino se distingue por su meticulosidad en la planificación de rutinas y dietas, asegurándose de que
